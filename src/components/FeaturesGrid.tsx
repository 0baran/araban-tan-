...
export default function FeaturesGrid({onNavigate}: FeaturesGridProps) {
  ...
  return (
    <View style={styles.featuresGrid}>
      ...
      <TouchableOpacity style={[styles.glassCard, styles.featureCard, {backgroundColor: colors.card}]} onPress={() => onNavigate('errorcodes')}>
      ...
      <TouchableOpacity style={[styles.glassCard, styles.featureCard, {backgroundColor: colors.card}]} onPress={() => onNavigate('performance')}>
      ...
      <TouchableOpacity style={[styles.glassCard, styles.featureCard, {backgroundColor: colors.card}]} onPress={() => onNavigate('vehicleinfo')}>
        <Text style={styles.featureIcon}>🚗</Text>
      ...
      <TouchableOpacity style={[styles.glassCard, styles.featureCard, {backgroundColor: colors.card}]} onPress={() => onNavigate('freezeframe')}>
      ...
      <TouchableOpacity style={[styles.glassCard, styles.featureCard, {backgroundColor: colors.card}]} onPress={() => onNavigate('settings')}>
        <Text style={styles.featureIcon}>⚙️</Text>
