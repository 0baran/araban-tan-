    ...
    return (
      <Component
        ...
        onNavigate={(screen: string | null) => {
          if (screen === null) navigation.goBack();
...
export default function AppNavigator() {
  return (
    <Stack.Navigator screenOptions={{headerShown: false, animation: 'slide_from_right'}}>
      ...
      <Stack.Screen name="ErrorCodes" component={withNavProps(ErrorCodesScreen)} />
      <Stack.Screen name="LiveData" component={withNavProps(LiveDataScreen)} />
      <Stack.Screen name="HiddenFeature" component={withNavProps(HiddenFeatureScreen)} />
      <Stack.Screen name="Settings" component={withNavProps(SettingsScreen)} />
      <Stack.Screen name="Performance" component={withNavProps(PerformanceScreen)} />
      <Stack.Screen name="FreezeFrame" component={withNavProps(FreezeFrameScreen)} />
      <Stack.Screen name="VehicleInfo" component={withNavProps(VehicleInfoScreen)} />
      <Stack.Screen name="DataLog" component={withNavProps(DataLogScreen)} />
      <Stack.Screen name="Log" component={withNavProps(LogScreen)} />
      <Stack.Screen name="Changelog" component={withNavProps(ChangelogScreen)} />
      <Stack.Screen name="Vehicles" component={withNavProps(VehiclesScreen)} />
      <Stack.Screen name="TripSummary" component={withNavProps(TripSummaryScreen)} />
