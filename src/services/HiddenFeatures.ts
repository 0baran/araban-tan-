...
export const HIDDEN_FEATURES: HiddenFeature[] = [
  ...
  },
  {
    ...
    description:
      'Kumandadan kilit açma tuşuna basılı tutarak tüm camları indirir.',
    category: 'comfort',
    manufacturer: ['ford'],
    compatibility: ['obd2'],
    readCmd: '22 17 01',
  ...
  },
  {
    ...
    description:
      'Kumandadaki panik alarmı için tuşa 2 kere basma zorunluluğu getirir.',
    category: 'safety',
    manufacturer: ['ford'],
    compatibility: ['obd2'],
    readCmd: '22 01 02',
  ...
  },
  {
    ...
    description:
      'Emniyet kemeri takılmadığında çalan sinir bozucu sesi kapatır.',
    category: 'comfort',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'],
    compatibility: ['obd2'],
    readCmd: '22 01 02',
  ...
  },
  {
    ...
    description:
      'Geri vitese takıldığında sağ aynanın kaldırımı göstermesi için aşağı inmesi.',
    category: 'comfort',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'],
    compatibility: ['obd2'],
    readCmd: '22 04 01',
  ...
  },
  {
    ...
    description:
      'Multimedya ekranına Gündüz Farı (DRL) açma/kapatma menüsü ekler.',
    category: 'lighting',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'],
    compatibility: ['obd2'],
    readCmd: '22 09 01',
  ...
  },
  {
    ...
    description:
      'Silecekler su attıktan 5 saniye sonra akan son damlayı silmek için bir tur daha çalışır.',
    category: 'comfort',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'],
    compatibility: ['obd2'],
    readCmd: '22 09 02',
  ...
  // --- BMW / MINI (BimmerCode FDL) ---
  {
    ...
    description:
      'Seyir halindeyken multimedya ekranında video oynatılmasını sağlar (SPEEDLIMIT_VIEW).',
    category: 'multimedia',
    manufacturer: ['bmw'],
    compatibility: ['obd2'],
    readCmd: '22 30 00',
  ...
  },
  {
    ...
    description:
      'Elektrikli bagajı olan araçlarda kumandadan bagaj kapatma izni verir.',
    category: 'comfort',
    manufacturer: ['bmw'],
    compatibility: ['obd2'],
    readCmd: '22 30 03',
  ...
  // --- FCA GRUBU (AlfaOBD) ---
  {
    ...
    description:
      'Uconnect ekranında Yağ Sıcaklığı, G-Force gibi SRT performans verilerini açar.',
    category: 'performance',
    manufacturer: ['fca'],
    compatibility: ['obd2'],
    readCmd: '22 01 01',
  ...
  },
  {
    ...
    description:
      'Farları LED ile değiştirdiğinizde ekranda yanan arıza ışığını Body Computer üzerinden kapatır.',
    category: 'lighting',
    manufacturer: ['fca'],
    compatibility: ['obd2'],
    readCmd: '22 01 02',
  ...
  },
  {
    ...
    description:
      'Uzun farları yakınca sis farlarının otomatik sönmesini iptal eder.',
    category: 'lighting',
    manufacturer: ['fca'],
    compatibility: ['obd2'],
    readCmd: '22 01 03',
  ...
  // --- PSA GRUBU (Peugeot, Citroen) ---
  {
    ...
    description:
      'Multimedya ekranına Yağ Sıcaklığı ve Lastik Basınçlarını gösteren menü ekler.',
    category: 'dashboard',
  ...
  // --- RENAULT / DACIA ---
  {
    ...
    description:
      'R-Link multimedya sisteminde Renault Sport (G-Force, Tork) monitörünü aktif eder.',
    category: 'performance',
  ...
  // ============================================
  {
    ...
    description:
      'Direksiyonu çevirdiğiniz yöndeki sis farı yanar. (DDT4All Modu)',
    category: 'lighting',
  ...
  },
  {
    ...
    description:
      'Gösterge panelinde dış sıcaklık ve saat bilgisini aktifleştirir.',
    category: 'dashboard',
  ...
  },
  {
    ...
    description:
      'Aracın otomatik Start/Stop özelliğini kalıcı olarak devre dışı bırakır.',
    category: 'performance',
...
export function detectManufacturer(vin: string): Manufacturer {
  ...
  if (v.startsWith('WBA') || v.startsWith('WBS')) {
    return 'bmw';
  }
  if (
    v.startsWith('WVW') ||
  ...
  if (v.startsWith('1FA') || v.startsWith('WF0') || v.startsWith('3FA')) {
    return 'ford';
  }
  if (v.startsWith('ZFA') || v.startsWith('1C4')) {
    return 'fca';
  }
  if (v.startsWith('VF1')) {
    return 'renault';
  }
  if (v.startsWith('VF3') || v.startsWith('VF7')) {
    return 'psa';
  }
  return 'universal';
}
