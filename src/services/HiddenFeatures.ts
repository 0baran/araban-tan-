...
export const ALL_FEATURES: HiddenFeature[] = [
  // 🟣 BMW & MINI GRUBU (BimmerCode Benzeri) 🟣
  {
    id: 'bmw_digital_speedo',
    name: 'Dijital Hız Göstergesi',
    description: 'Analog kadrana ek olarak yol bilgisayarında dijital hızın (V= XX km/h) gösterilmesi.',
    category: 'Gösterge',
    manufacturer: ['bmw', 'mini'], compatibility: ["obd2"], readCmd: '223000',
    writeOn: '2E300001',
    writeOff: '2E300000',
    readHeader: '7F0',
    writeHeader: '7F0',
  ...
  {
    id: 'bmw_angel_eyes',
    name: 'Angel Eyes Parlaklığı (%100)',
    description: 'Kısa farlar yandığında gündüz farlarının (Angel Eyes) kısılmasını engeller, hep %100 parlaklıkta yanar.',
    category: 'Aydınlatma',
    manufacturer: ['bmw', 'mini'], compatibility: ["obd2"], readCmd: '223011',
    writeOn: '2E301164', // 100 in hex is 64
    writeOff: '2E301108',
    readHeader: '720',
    writeHeader: '720',
  },
  {
    ...
    description: 'Sürücü ve yolcu için emniyet kemeri sesli uyarısının susturulması.',
    category: 'Güvenlik',
    manufacturer: ['bmw', 'mini'], compatibility: ["obd2"], readCmd: '223001',
    writeOn: '2E300100',
    writeOff: '2E300101',
    readHeader: '720',
    writeHeader: '720',
  ...
  {
    id: 'bmw_m_logo',
    name: 'M Performance Gösterge Logosu',
    description: 'Kontağı açtığınızda standart BMW logosu yerine M Performance animasyonunun çıkması.',
    category: 'Gösterge',
    manufacturer: ['bmw', 'mini'], compatibility: ["obd2"], readCmd: '223002',
    writeOn: '2E300201',
    writeOff: '2E300200',
    readHeader: '7F0',
    writeHeader: '7F0',
  ...
  {
    id: 'bmw_start_eco_pro',
    name: 'Start in Eco Pro Modu',
    description: 'Aracın her çalıştırıldığında Comfort yerine direkt Eco Pro modunda başlaması.',
    category: 'Motor',
    manufacturer: ['bmw', 'mini'], compatibility: ["obd2"], readCmd: '223005',
    writeOn: '2E300507',
    writeOff: '2E300504',
    readHeader: '720',
    writeHeader: '720',
  ...
  // 🟠 TOYOTA & LEXUS GRUBU (Carista Benzeri) 🟠
  {
    id: 'toyota_signal_count',
    name: 'Sinyal Tık Sayısını 5 Yapma',
    description: 'Dokunmatik sinyal koluna hafifçe dokunulduğunda 3 yerine 5 kere yanıp sönmesi.',
    category: 'Aydınlatma',
    manufacturer: ['toyota', 'lexus'], compatibility: ["obd2"], readCmd: '221100',
    writeOn: '2E110005',
    writeOff: '2E110003',
    readHeader: '750',
    writeHeader: '750',
  ...
  {
    id: 'toyota_reverse_beep',
    name: 'Geri Vites Bip Sesi İptali',
    description: 'Geri vitese takıldığında kabin içinde sürekli öten "bip bip" sesinin tek biple sınırlandırılması.',
    category: 'Güvenlik',
    manufacturer: ['toyota', 'lexus'], compatibility: ["obd2"], readCmd: '221101',
    writeOn: '2E110100',
    writeOff: '2E110101',
    readHeader: '750',
    writeHeader: '750',
  },
  {
    ...
    name: 'Kumandadan Cam/Sunroof İndirme',
    description: 'Anahtarın kilit açma tuşuna uzun basıldığında tüm camların ve sunroofun açılması.',
    category: 'Konfor',
    manufacturer: ['toyota', 'lexus'], compatibility: ["obd2"], readCmd: '221102',
    writeOn: '2E110201',
    writeOff: '2E110200',
    readHeader: '750',
    writeHeader: '750',
  ...
  // 🟤 FIAT, CHRYSLER, JEEP, ALFA ROMEO (AlfaOBD Benzeri) 🟤
  {
    id: 'fca_proxi_alignment',
    name: 'Proxi Hizalama (Proxi Alignment)',
    description: 'Araca sonradan donanım takıldığında (hız sabitleyici vb.) kilometre saatinin yanıp sönmesini durdurur ve donanımı tanıtır.',
    category: 'Diagnostik',
    manufacturer: ['fiat', 'chrysler', 'jeep', 'alfa'], compatibility: ["obd2"], readCmd: '3101',
    writeOn: '310101',
    writeOff: '310100',
    readHeader: '700',
    writeHeader: '700',
  ...
  {
    id: 'fca_srt_pages',
    name: 'SRT Performance Menüsü',
    description: 'Uconnect veya gösterge panelinde beygir gücü, G-kuvveti vb. araç dinamiklerini gösteren SRT performans sayfalarının açılması.',
    category: 'Gösterge',
    manufacturer: ['jeep', 'chrysler', 'dodge'], compatibility: ["obd2"], readCmd: '222000',
    writeOn: '2E200001',
    writeOff: '2E200000',
    readHeader: '7E0',
    writeHeader: '7E0',
  ...
  // 🔴 PEUGEOT & CITROEN (PSA Grubu) 🔴
  {
    id: 'psa_gt_line_theme',
    name: 'GT Line Teması (Kırmızı/Bakır)',
    description: 'Gösterge panelinde ve multimedya ekranında GT Line spor temanın (kırmızı/bakır renkler) açılması.',
    category: 'Multimedya',
    manufacturer: ['peugeot', 'citroen', 'ds', 'opel'], compatibility: ["obd2"], readCmd: '221000',
    writeOn: '2E100001',
    writeOff: '2E100000',
    readHeader: '700',
    writeHeader: '700',
  ...
  {
    id: 'psa_rear_wiper',
    name: 'Geri Viteste Arka Silecek İptali',
    description: 'Yağmurlu havada veya ön silecekler açıkken geri vitese takıldığında arka sileceğin otomatik çalışmasının iptal edilmesi.',
    category: 'Konfor',
    manufacturer: ['peugeot', 'citroen', 'ds', 'opel'], compatibility: ["obd2"], readCmd: '221001',
    writeOn: '2E100100',
    writeOff: '2E100101',
    readHeader: '700',
    writeHeader: '700',
  ...
  // 🟢 VAG GRUBU GİZLİ ÖZELLİKLERİ 🟢
  {
    id: 'vag_needle_sweep',
    name: 'Kadran Selamlama (Needle Sweep)',
    description: 'Kontağı açtığınızda hız ve devir ibrelerinin sona vurup geri dönmesi (Görsel şölen).',
    category: 'Gösterge',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'], compatibility: ["obd2"], readCmd: '1003\r2701\r221A00',
    writeOn: '1003\r2701\r2E1A0001',
    writeOff: '1003\r2701\r2E1A0000',
    readHeader: '714',
    writeHeader: '714',
  },
  {
    id: 'vag_us_parking',
    name: 'Amerikan Park',
    description: 'Ön sinyal lambalarının %30 şiddetle sürekli yanması (Sinyal verdiğinizde normal yanıp söner).',
    category: 'Aydınlatma',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'], compatibility: ["obd2"], readCmd: '1003\r2701\r220900',
    writeOn: '1003\r2701\r2E09001E', // 30% intensity
    writeOff: '1003\r2701\r2E090000',
    readHeader: '709',
    writeHeader: '709',
  },
  {
    id: 'vag_acoustic_lock',
    name: 'Korna ile Kilit Onayı',
    description: 'Aracı kilitlerken 1 kez, açarken 2 kez kornadan (veya alarm sireninden) onay sesi gelmesi.',
    category: 'Güvenlik',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'], compatibility: ["obd2"], readCmd: '1003\r2701\r220901',
    writeOn: '1003\r2701\r2E090101',
    writeOff: '1003\r2701\r2E090100',
    readHeader: '709',
    writeHeader: '709',
  },
  {
    id: 'vag_vim',
    name: 'Video in Motion (VIM)',
    description: 'Hareket halindeyken (10 km/h üzeri) multimedya ekranında video oynatabilme.',
    category: 'Multimedya',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'], compatibility: ["obd2"], readCmd: '1003\r2701\r225F00',
    writeOn: '1003\r2701\r2E5F00FF',
    writeOff: '1003\r2701\r2E5F0000',
    readHeader: '75F',
    writeHeader: '75F',
  },
  {
    id: 'vag_refuel_quantity',
    name: 'Ek Yakıt Miktarı Göstergesi',
    description: 'Yol bilgisayarında deponun tam dolması için alması gereken yakıtı litre (L) olarak gösterir.',
    category: 'Gösterge',
    manufacturer: ['volkswagen', 'audi', 'seat', 'skoda'], compatibility: ["obd2"], readCmd: '1003\r2701\r221A02',
    writeOn: '1003\r2701\r2E1A0201',
    writeOff: '1003\r2701\r2E1A0200',
    readHeader: '714',
    writeHeader: '714',
  },

  // 🔵 FORD GRUBU GİZLİ ÖZELLİKLERİ 🔵
  {
    id: 'ford_auto_lock',
    name: 'Otomatik Kapı Kilitleme',
    description: 'Araç hızı 20 km/h yi geçtiğinde tüm kapıların otomatik olarak kilitlenmesi.',
    category: 'Güvenlik',
    manufacturer: ['ford'], compatibility: ["obd2"], readCmd: '22DE00',
    writeOn: '2EDE0001',
    writeOff: '2EDE0000',
    readHeader: '726',
    writeHeader: '726',
  ...
  {
    id: 'ford_eco_mode',
    name: 'Eko Mod (EcoMode) Menüsü',
    description: 'Gösterge panelinde sürüş stilinize göre puan veren Çiçek/Yaprak (EcoMode) sekmesinin açılması.',
    category: 'Gösterge',
    manufacturer: ['ford'], compatibility: ["obd2"], readCmd: '22DE01',
    writeOn: '2EDE0101',
    writeOff: '2EDE0100',
    readHeader: '720',
    writeHeader: '720',
  ...
  {
    id: 'ford_shift_indicator',
    name: 'Vites Atma Uyarısı',
    description: 'Optimum yakıt tüketimi için yukarı vites değiştirmeniz gereken devirde ekranda uyarı çıkması.',
    category: 'Gösterge',
    manufacturer: ['ford'], compatibility: ["obd2"], readCmd: '22DE02',
    writeOn: '2EDE0201',
    writeOff: '2EDE0200',
    readHeader: '720',
    writeHeader: '720',
  ...
  {
    id: 'ford_alarm_activation',
    name: 'Çevre Güvenlik Alarmı',
    description: 'Aracın kapısı zorlanarak açıldığında kornanın kesik kesik çalarak alarm vermesi.',
    category: 'Güvenlik',
    manufacturer: ['ford'], compatibility: ["obd2"], readCmd: '22DE03',
    writeOn: '2EDE0301',
    writeOff: '2EDE0300',
    readHeader: '726',
    writeHeader: '726',
  ...
  // 🟡 RENAULT & DACIA GRUBU GİZLİ ÖZELLİKLERİ 🟡
  {
    id: 'renault_start_stop',
    name: 'Start-Stop İptali',
    description: 'Her çalıştırmada devreye giren otomatik motor durdurma (Start-Stop) sisteminin kalıcı olarak kapatılması.',
    category: 'Motor',
    manufacturer: ['renault', 'dacia'], compatibility: ["obd2"], readCmd: '2101',
    writeOn: '3B0100',
    writeOff: '3B0101',
    readHeader: '7A0',
    writeHeader: '7A0',
  ...
  {
    id: 'renault_fatigue_detect',
    name: 'Yorgunluk Tespit Asistanı',
    description: 'R-Link veya gösterge ekranına yorgunluk algılama asistanının (UTA) eklenmesi.',
    category: 'Sürüş Asistanı',
    manufacturer: ['renault', 'dacia'], compatibility: ["obd2"], readCmd: '2102',
    writeOn: '3B0201',
    writeOff: '3B0200',
    readHeader: '743',
    writeHeader: '743',
  },
  {
    ...
    description: 'R-Link 2 multimedya ekranında akıllı telefon yansıtma (Android Auto / Apple CarPlay) özelliğinin açılması.',
    category: 'Multimedya',
    manufacturer: ['renault'], compatibility: ["obd2"], readCmd: '2103',
    writeOn: '3B0301',
    writeOff: '3B0300',
    readHeader: '745',
    writeHeader: '745',
  ...
  },
  {
    ...
    readCmd: '220907',
    readHeader: '709',
    writeOn: '2E090705', // 5 flashes
    writeOff: '2E090703', // 3 flashes
    writeHeader: '709',
  },
  {
    id: 'vag_winking_drl',
  ...
  },
  {
    ...
    readCmd: '220301',
    readHeader: '703',
    writeOn: '2E030102', // 02 is Strong
    writeOff: '2E030100', // 00 is Standard
    writeHeader: '703',
  },
  {
    id: 'opel_camera_menu',
