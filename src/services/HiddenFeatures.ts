...
export const ALL_FEATURES: HiddenFeature[] = [
  ...
  // 🟤 FIAT, CHRYSLER, JEEP, ALFA ROMEO (AlfaOBD Benzeri) 🟤
  {
    ...
    category: 'Diagnostik',
    manufacturer: ['fiat', 'chrysler', 'jeep', 'alfa'],
    readCmd: '3101',
    writeOn: '310101',
    writeOff: '310100',
    readHeader: '700',
  ...
  },
  {
    ...
    category: 'Gösterge',
    manufacturer: ['jeep', 'chrysler', 'dodge'],
    readCmd: '222000',
    writeOn: '2E200001',
    writeOff: '2E200000',
    readHeader: '7E0',
  ...
  // 🔴 PEUGEOT & CITROEN (PSA Grubu) 🔴
  {
    ...
    category: 'Multimedya',
    manufacturer: ['peugeot', 'citroen', 'ds', 'opel'],
    readCmd: '221000',
    writeOn: '2E100001',
    writeOff: '2E100000',
    readHeader: '700',
