export const DTC_DICTIONARY: Record<string, string> = {
  ...
  P0171: "Sistem Çok Fakir (Sıra 1) - Hava fazla veya yakıt az. (Oksijen sensörü, vakum kaçağı veya MAF sensörü kontrol edilmeli)",
  P0172: "Sistem Çok Zengin (Sıra 1) - Yakıt fazla. (Enjektör sızıntısı veya hava filtresi tıkanıklığı)",
  P0300: "Rastgele/Çoklu Silindir Teklemesi Tespit Edildi (Bujiler, bobinler veya yakıt pompası kontrol edilmeli)",
  ...
  P0420: "Katalizör Sistemi Verimliliği Eşik Değerin Altında (Sıra 1) - Katalitik Konvertör veya Oksijen Sensörü arızası",
...
export function getDtcDescription(code: string): string {
  ...
  return DTC_DICTIONARY[cleanCode] || "Bilinmeyen Hata Kodu. Çevrimiçi kontrol edilmesi önerilir.";
}
