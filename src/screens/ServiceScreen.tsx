        ...
        {text: 'İptal', style: 'cancel'},
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              const resp = await obd2Service.sendRawAT(command);
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            Aşağıdaki komutlar aracın ECU'suna (Beyin) doğrudan çift yönlü
            (bi-directional) yazma/tetikleme komutları gönderir. Sadece motor
            çalışıyorken ve Park halindeyken kullanın.
          </Text>
        </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              runCommand(
                'EPB Aç',
                '04042',
                'Elektronik Park Freni (EPB) pistonları arka balata değişimi için GERİ ÇEKİLECEKTİR. Frenler boşalır!',
              )
            }>
            <Text style={styles.actionBtnText}>
              EPB Servis Modu (Pistonları Çek)
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              runCommand(
                'EPB Kapat',
                '04043',
                'Elektronik Park Freni pistonları normal çalışma pozisyonuna İLERİ İTİLECEKTİR.',
              )
            }>
            <Text style={styles.actionBtnText}>
              EPB Normal Mod (Pistonları Kapat)
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              runCommand(
                'DPF Regen',
                '221234',
                'Dizel Partikül Filtresi (DPF) ZORLA REJENERASYON işlemi başlatılacak. Egzoz sıcaklığı 600°C üzerine çıkabilir. Aracı açık alanda tutun!',
              )
            }>
            <Text style={styles.actionBtnText}>
              DPF Zorla Rejenerasyon Başlat
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              runCommand(
                'Throttle',
                '04060',
                'Gaz kelebeği (Throttle Body) adaptasyonu başlatılacak. Motor çalışmıyorken sadece kontak açıkken (Key ON Engine OFF) yapın.',
              )
            }>
