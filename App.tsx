...
const APP_VERSION = '3.1.1.20260523.1402';
...
const styles = StyleSheet.create({
  ...
  headerSub: {color: 'rgba(255, 255, 255, 0.3)', fontSize: 12, fontWeight: '500', letterSpacing: 1, marginTop: 2},
  connectButton: {flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255, 255, 255, 0.1)', paddingHorizontal: 18, paddingVertical: 10, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.2)', gap: 8},
  ...
  gaugeLabel: {color: 'rgba(255, 255, 255, 0.5)', fontSize: 12, fontWeight: 'bold', letterSpacing: 1, marginBottom: 20},
  ...
  featureValue: {color: '#ffffff', fontSize: 28, fontWeight: '900', marginBottom: 5},
  featureLabel: {color: '#ffffff', fontSize: 12, fontWeight: 'bold', letterSpacing: 1, textAlign: 'center'},
  featureHint: {color: 'rgba(255,255,255,0.3)', fontSize: 10, marginTop: 4, letterSpacing: 1},
  quickActions: {flexDirection: 'row', justifyContent: 'space-between'},
  quickAction: {flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(30, 33, 40, 0.7)', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', marginHorizontal: 5, gap: 8},
  quickActionIcon: {fontSize: 18},
  quickActionText: {color: 'rgba(255,255,255,0.7)', fontSize: 12, fontWeight: '800', letterSpacing: 1},
  tabRow: {flexDirection: 'row', marginBottom: 20, gap: 8},
  tab: {flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)'},
  tabActive: {backgroundColor: 'rgba(0,191,255,0.15)', borderColor: '#00bfff'},
  tabText: {color: 'rgba(255,255,255,0.5)', fontWeight: '700', fontSize: 12, letterSpacing: 1},
  tabTextActive: {color: '#00bfff'},
  modalOverlay: {flex: 1, backgroundColor: 'rgba(0,0,0,0.8)', justifyContent: 'flex-end'},
  modalContent: {backgroundColor: '#1E2128', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 30, minHeight: 400, maxHeight: 650},
  modalHeader: {flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10},
  modalTitle: {color: '#fff', fontSize: 20, fontWeight: 'bold'},
  modalSubtitle: {color: 'rgba(255,255,255,0.5)', fontSize: 12, marginBottom: 15, lineHeight: 18},
  inputLabel: {color: 'rgba(255,255,255,0.5)', fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 6, marginTop: 8},
  input: {backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12, padding: 14, color: '#fff', fontSize: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', marginBottom: 8, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace'},
  connectWifiBtn: {backgroundColor: 'rgba(0,191,255,0.2)', borderRadius: 15, padding: 16, alignItems: 'center', marginTop: 12, borderWidth: 1, borderColor: 'rgba(0,191,255,0.3)'},
  connectWifiText: {color: '#00bfff', fontWeight: '800', fontSize: 14, letterSpacing: 1.5},
  refreshButton: {marginTop: 10, padding: 12, backgroundColor: 'rgba(0,191,255,0.1)', borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(0,191,255,0.2)'},
  refreshText: {color: '#00bfff', fontWeight: '700', fontSize: 12, letterSpacing: 1},
  deviceItem: {flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.05)', padding: 15, borderRadius: 15, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)'},
  deviceIcon: {fontSize: 24, marginRight: 15},
  deviceName: {color: '#fff', fontSize: 16, fontWeight: 'bold'},
  deviceAddr: {fontSize: 12},
  newBadge: {backgroundColor: '#00bfff', color: '#fff', fontSize: 10, fontWeight: '900', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, letterSpacing: 1, overflow: 'hidden'},
  closeButton: {marginTop: 20, padding: 15, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 15, alignItems: 'center'},
